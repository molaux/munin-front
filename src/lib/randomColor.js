...
export default (function(root, factory) {
  ...
  var randomColor = function (options) {
    ...
    if (options.seed !== undefined && options.seed !== null && (options.seed === parseInt(options.seed, 10) || typeof options.seed === 'string')) {
      seed = new alea(options.seed);
    // A string was passed as a seed
  } else if (options.seed !== undefined && options.seed !== null && (typeof options.seed === 'object' || typeof options.seed === 'function')) {
      seed = options.seed
  ...
  function dist(hex1, hex2) {
    var [red1, green1, blue1] = hexToScalar(hex1),
        [red2, green2, blue2] = hexToScalar(hex2);
  ...
  function minDist(hex, hexs) {
    return hexs.reduce((min, h) => {
        var d = dist(hex, h)
        return d < min ? d : min
      }, 1);
  }
  ...
  function HexToHSB (hex) {
    var [red, green, blue] = hexToScalar(hex);
